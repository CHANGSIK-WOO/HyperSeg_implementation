...
def evaluation():
    ...
    for val_data in val_data_list:
        ...
        for split in splits:
            ...
            eval_dataset = RefCOCO_dataset_test(json_path=cur_json_path, tokenizer=tokenizer, data_args=data_args)
            dataloader_params = {
            ...
            def load_ref_dataset():
                return RefCOCO_dataset_test(json_path=cur_json_path, tokenizer=tokenizer, data_args=data_args)
