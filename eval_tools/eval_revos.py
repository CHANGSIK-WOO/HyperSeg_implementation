...
if __name__ == '__main__':
    ...
    parser.add_argument("--revos_pred_path", type=str, default='')
    parser.add_argument("--revos_exp_path", type=str, default="/ReVOS/meta_expressions_valid_.json")
    parser.add_argument("--revos_mask_path", type=str, default="/ReVOS/mask_dict.json")
    parser.add_argument("--revos_foreground_mask_path", type=str, default="/ReVOS/mask_dict_foreground.json")
